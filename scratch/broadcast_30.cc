...
NS_LOG_COMPONENT_DEFINE("smartHouse_broadcast_30");

int main(int argc, char* argv[])
{
// ----------------- Configura logs do terminal -------------------------

    LogComponentEnable("smartHouse_broadcast_30", LOG_LEVEL_INFO); 
...
// ------------------------ Agrupa todos os nós -------------------------
    ...
    NodeContainer allNodes = NodeContainer( 
        ...
        chuveiroNode, carroNode, colarNode,
        aCNodes, coleiraNode,
        anelNode, cafeteiraNode,
...
// --------------------- Configurando rede wifi --------------------------
    ...
    chuveiroDev, carroDev, colarDev, coleiraDev, ApplicationsDev;
...
// ------------------------ Atribuir endereços IP -------------------
    ...
    ApplicationContainer computadorServerApp, espelhoServerApp, 
        ...
        colarServerApp, coleiraServerApp, serverApplications;
