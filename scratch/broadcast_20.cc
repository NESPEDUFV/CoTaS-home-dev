...
NS_LOG_COMPONENT_DEFINE("smartHouse_broadcast_20");

int main(int argc, char* argv[])
{
// ----------------- Configura logs do terminal -------------------------

    LogComponentEnable("smartHouse_broadcast_20", LOG_LEVEL_INFO); 
...
// ------------------------ Agrupa todos os nós -------------------------
    ...
    NodeContainer allNodes = NodeContainer( 
        ...
        aCNodes, roteadorNodes, ApplicationsNodes
    );
...
// --------------------- Configurando rede wifi --------------------------
    ...
    cameraDev, guardaRoupaDev, aCNDev, ApplicationsDev;
...
// ------------------------ Atribuir endereços IP -------------------
    ...
    ApplicationContainer computadorServerApp, espelhoServerApps, televisaoServerApp, 
                        ...
                        aCServerApps, serverApplications;
