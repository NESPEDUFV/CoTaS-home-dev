...
NS_LOG_COMPONENT_DEFINE("smartHouse_broadcast_10");

int main(int argc, char* argv[])
{
// ----------------- Configura logs do terminal -------------------------

    LogComponentEnable("smartHouse_broadcast_10", LOG_LEVEL_INFO); 
...
// ------------------------ Agrupa todos os nós -------------------------
    ...
    NodeContainer allNodes = NodeContainer( 
        ...
        echoDotNodes, cameraNodes, roteadorNodes, ApplicationsNodes
    );
...
// ------------------------ Atribuir endereços IP -------------------
    ...
    ApplicationContainer computadorServerApp, espelhoServerApps, televisaoServerApp, 
                        echoDotServerApps, cameraServerApps, serverApplications;
