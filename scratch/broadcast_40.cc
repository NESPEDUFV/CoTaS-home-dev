...
NS_LOG_COMPONENT_DEFINE("smartHouse_broadcast_40");

int main(int argc, char* argv[])
{
// ----------------- Configura logs do terminal -------------------------

    LogComponentEnable("smartHouse_broadcast_40", LOG_LEVEL_INFO); 
...
// ------------------------ Agrupa todos os nós -------------------------
    ...
    NodeContainer allNodes = NodeContainer( 
        ...
        aCNodes, coleiraNode,
        anelNode, cafeteiraNode, janelaCortinaNodes,
...
// --------------------- Configurando rede wifi --------------------------
    ...
    janelaCortinaDev, ApplicationsDev;
