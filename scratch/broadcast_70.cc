...
NS_LOG_COMPONENT_DEFINE("smartHouse_broadcast_70");

int main(int argc, char* argv[])
{
// ----------------- Configura logs do terminal -------------------------

    LogComponentEnable("smartHouse_broadcast_70", LOG_LEVEL_INFO); 
    LogComponentEnable("BroadcastProviderApplication", LOG_LEVEL_INFO);
    LogComponentEnable("BroadcastConsumerApplication", LOG_LEVEL_INFO);
...
// ------------------------ Agrupa todos os nós -------------------------
    ...
    NodeContainer allNodes = NodeContainer( 
        ...
        roteadorNodes, ApplicationsNodes
    ); //PisoNodes,
...
// ------------------------ Atribuir endereços IP -------------------
    ...
    BroadcastProviderHelper ObjectService(19);
    ...
    BroadcastConsumerHelper ClientConsumer(Ipv4Address("255.255.255.255"), 19);
