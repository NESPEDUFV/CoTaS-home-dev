...
NS_LOG_COMPONENT_DEFINE("smartHouse_broadcast_50");

int main(int argc, char* argv[])
{
// ----------------- Configura logs do terminal -------------------------

    LogComponentEnable("smartHouse_broadcast_50", LOG_LEVEL_INFO); 
...
// 16 aplicações + CoTaS
    ...
    lampadaNodes.Create(2);
    
    NodeContainer interruptorNodes;
    interruptorNodes.Create(2);
...
// ------------------------ Agrupa todos os nós -------------------------
    ...
    NodeContainer allNodes = NodeContainer( 
        ...
        lavaLouçasNode, interruptorNodes, aCNodes, 
...
// --------------------- Configurando rede wifi --------------------------
    ...
    lavaLouçasDev, interruptorDev, ApplicationsDev;
...
// ------------------------ Atribuir endereços IP -------------------
    ...
    ApplicationContainer computadorServerApp, espelhoServerApp, 
        ...
        interruptorServerApp, lavaLouçasServerApp, serverApplications;
